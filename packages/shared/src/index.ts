...
/**
 * Quantitative and behavioral mirror metrics revealing the intention-action gap.
 */
export interface DigitalSelfAwareness {
...
export interface CompanionDailyReflection {
  ...
  advice: string;
  timestamp: number;
  digitalSelfAwareness?: DigitalSelfAwareness;
}
